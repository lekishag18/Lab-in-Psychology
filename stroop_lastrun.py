...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Admin\\OneDrive\\Desktop\\Lekisha\\College\\Lab in Psychology\\stroop_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Psychophy.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        text.setColor(font_colour, colorSpace='rgb')
        text.setText(word)
